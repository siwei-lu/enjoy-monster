...
router.post('/graphql', graphql_server_koa_1.graphqlKoa({ schema: parsedSchema, context: { knex } }));
router.get('/graphql', graphql_server_koa_1.graphqlKoa({ schema: parsedSchema, context: { knex } }));
